...
function getProducers() {
    ...
    return eos.getTableRows(params).then(resp => {
        ...
        <tr class="prod-row">
            <td>${i+1}<br>
            <a href="https://wax.bloks.io/account/${prod.wallet}" target="_blank">${prod.wallet}</a>
            </td>
            <td>Total Votes: ${prod.total_vote}<br>
            Reward/24h: ${prod.next_reward}
            </td>
    ...
    <div>
        <details>
            ...
            <p><a href="https://wax.bloks.io/account/${prod.wallet}" target="_blank">${prod.wallet}</a></p>
        </details>
